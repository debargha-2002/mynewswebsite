...
const Pagination = () => {
  ...
  return (
    <div className={` w-screen flex lg:h-[18vh] items-center justify-center bg-slate-900 text-white sm:gap-x-7 font-semibold text-lg sm:h-[20vh] h-[24vh] gap-x-3 ${lightMode ? "" : " bg-[#0e0e0e] shadow-[0_-2px_10px_0_rgb(107,114,128)]"}`}>
